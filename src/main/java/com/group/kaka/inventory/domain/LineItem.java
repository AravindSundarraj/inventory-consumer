...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4057782452495525982L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LineItem\",\"namespace\":\"com.group.kafka.inventory.domain\",\"fields\":[{\"name\":\"ItemCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemDescription\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemPrice\",\"type\":[\"null\",\"double\"]},{\"name\":\"ItemQty\",\"type\":[\"null\",\"int\"]},{\"name\":\"TotalValue\",\"type\":[\"null\",\"string\"]}]}");
  ...
  @Deprecated public CharSequence TotalValue;
   ...
   */
  public LineItem(CharSequence ItemCode, CharSequence ItemDescription, Double ItemPrice, Integer ItemQty, CharSequence TotalValue) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 4: TotalValue = (CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setTotalValue(CharSequence value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setTotalValue(CharSequence value) {
    ...
    public LineItem build() {
      try {
        ...
        record.TotalValue = fieldSetFlags()[4] ? this.TotalValue : (CharSequence) defaultValue(fields()[4]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        this.TotalValue = in.readString(this.TotalValue instanceof Utf8 ? (Utf8)this.TotalValue : null);
      }
